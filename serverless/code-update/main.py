...
function_url = "http://10.150.0.36:5000/code-update" # code-updateAPI ENDPOINT ON THE CONTROL NODE
...
def code_update(request):
    print("Code update function triggered")
    ...
    print("Code update function completed")