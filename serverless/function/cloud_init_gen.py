...
- apt-transport-https
write_files:
  - path: /tmp/cynthus.json
    permissions: '0600'
    owner: root:root
    content: |
      #content of cynthus service account json file
runcmd:
...
- gcloud auth activate-service-account --key-file=/tmp/cynthus.json
- mkdir -p /home/cynthus/code
- mkdir -p /home/cynthus/data
- gsutil cp -r gs://{self.bucket_name}/code /home/cynthus/code
- chown -R cynthus:cynthus /home/cynthus/code
- gsutil -m cp -r gs://{self.bucket_name}/data /home/cynthus/code/data
- chown -R cynthus:cynthus /home/cynthus/code/data
- python3 /home/cynthus/code/train_model.py > /home/cynthus/output.txt
- gsutil cp /home/cynthus/output.txt gs://{self.bucket_name}/output/output.txt
