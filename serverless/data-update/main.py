...
function_url = "http://10.150.0.36:5000/data-update" # data-updateAPI ENDPOINT ON THE CONTROL NODE
...
def data_update(request):
    print("Data update function triggered")
    ...
    print("Data update function completed")