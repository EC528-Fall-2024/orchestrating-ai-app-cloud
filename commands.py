...
def cli_entry_point():
    ...
    parser_setup_kaggle = subparsers.add_parser(
        'setup_kaggle', help='Instructions for setting up Kaggle API key')
    ...
    parser_kaggle = subparsers.add_parser('download-kaggle', help='Download Kaggle dataset')
    parser_kaggle.add_argument('dataset', help='The Kaggle dataset (e.g., "username/dataset-name")')
    parser_kaggle.add_argument('dest_path', help='Destination folder for the dataset')
